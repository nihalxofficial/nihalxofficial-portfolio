...
export const SKILL_CATEGORIES = [
  {
    ...
    title: "Frontend",
    skills: [
      { name: "HTML5 / CSS3", level: "expert", icon: "SiHtml5", color: "#E34F26" },
      { name: "Tailwind CSS", level: "expert", icon: "SiTailwindcss", color: "#38BDF8" },
      { name: "Advanced ES6", level: "advanced", icon: "SiJavascript", color: "#F7DF1E" },
      { name: "TypeScript", level: "intermediate", icon: "SiTypescript", color: "#3178C6" },
      { name: "React.js", level: "advanced", icon: "SiReact", color: "#61DAFB" },
      { name: "Next.js", level: "expert", icon: "SiNextdotjs", color: "#FFFFFF" },
      { name: "Daisy UI", level: "expert", icon: "SiDaisyui", color: "#FF007F" },
      { name: "Hero UI", level: "advanced", icon: "SiHeroui", color: "#005BC6" },
      { name: "Framer-Motion", level: "basic", icon: "SiFramer", color: "#F107A3" },
      { name: "Swiper", level: "expert", icon: "SiSwiper", color: "#6332F6" },
      { name: "Marquee", level: "expert", icon: "fas fa-infinity", color: "#FF5733" },
    ],
  },
  {
    icon: "fas fa-server",
    ...
    skills: [
      ...
      { name: "Express.js", level: "expert", icon: "SiExpress", color: "#C0C0C0" },
      { name: "MongoDB", level: "expert", icon: "SiMongodb", color: "#47A248" },
      { name: "Mongoose", level: "advanced", icon: "SiMongoose", color: "#E53E3E" },
      { name: "BetterAuth", level: "advanced", icon: "SiBetterauth", color: "#EB5424" },
      { name: "Redis", level: "intermediate", icon: "SiRedis", color: "#DC382D" },
      { name: "Golang", level: "intermediate", icon: "SiGo", color: "#00ADD8" },
      { name: "Gorm", level: "intermediate", icon: "SiGo", color: "#00ADD8" },
      { name: "PostgreSQL", level: "expert", icon: "SiPostgresql", color: "#4169E1" },
      { name: "Prisma", level: "advanced", icon: "SiPrisma", color: "#5A67D8" },
      { name: "WebSocket", level: "intermediate", icon: "SiSocketdotio", color: "#25C2A0" },
      { name: "REST APIs", level: "expert", icon: "FaServer", color: "#10B981" },
    ],
  },
  {
    icon: "fas fa-tools",
    title: "Tools",
    skills: [
      { name: "Git / GitHub", level: "expert", icon: "SiGithub", color: "#F05032" },
      { name: "NPM", level: "expert", icon: "SiNpm", color: "#CB3837" },
      { name: "Figma", level: "advanced", icon: "SiFigma", color: "#F24E1E" },
      { name: "Postman", level: "expert", icon: "SiPostman", color: "#FF6C37" },
      // { name: "AWS", level: "basic", icon: "FaAws", color: "#FF9900" },
      { name: "Gitlab", level: "advanced", icon: "SiGitlab", color: "#FC6D26" },
      { name: "pgAdmin", level: "advanced", icon: "SiPostgresql", color: "#5BA3D9" },
      // { name: "SQL Workbench", level: "intermediate", icon: "fas fa-database", color: "#F29111" },
      { name: "NoSQLBooster", level: "intermediate", icon: "SiMongodb", color: "#00ED64" },
      { name: "Docker", level: "advanced", icon: "SiDocker", color: "#2496ED" },
      { name: "CI/CD", level: "advanced", icon: "SiGithubactions", color: "#2088FF" },
      { name: "MongoDB Atlas", level: "advanced", icon: "SiMongodb", color: "#00ED64" },
      { name: "Neon", level: "intermediate", icon: "NeonCustom", color: "#00E5BF" },
      { name: "Vercel", level: "expert", icon: "SiVercel", color: "#FFFFFF" },
...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    tagBadges: ["Next.js", "BetterAuth"],
    chips: ["Next.js", "MongoDB", "BetterAuth", "Tailwind CSS"],
    desc: "A news portal delivering accurate, unbiased and timely news with category browsing, social authentication, a live breaking news ticker and responsive modern UI.",
    features: [
  ...
  },
  {
    ...
    chips: ["Next.js 15", "React 19", "Tailwind CSS", "Vercel"],
    desc: "A modern responsive app store platform where users can browse apps by category, search apps in real time, install or uninstall apps and manage their personal installed apps list with smooth loading states and optimized performance.",
    features: [
      "Real-time app search functionality",
    ...
    liveDemo: "https://next-app-store-tau.vercel.app",
