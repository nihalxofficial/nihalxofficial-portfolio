...
export const SKILL_CATEGORIES = [
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "Express.js", level: "expert", icon: "SiExpress", color: "#828282" },
      { name: "MongoDB", level: "expert", icon: "SiMongodb", color: "#47A248" },
      { name: "Mongoose", level: "advanced", icon: "SiMongoose", color: "#880000" },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "WebSocket", level: "intermediate", icon: "SiSocketdotio", color: "#010101" },
